      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex mt-2">
            {isAuth && (
              <Button className="bg-purple-600 text-white">Go To Chats</Button>
            )}
          </div>
          <p className="max-w-xxl mt-1 text-lg text-white">
            Join millions of students,reserchers and professionals to instanly
            answer question and understand reserch with AI{" "}
          </p>
          <div className="w-full mt-4">
            {isAuth ? (
              ...
              <Link href="/sign-in">
                <Button>
                  Log in to get started! <LogIn className="ml-2 h-4 w-4" />
                </Button>
              </Link>
            )}
          </div>
